  ...
  return (
    <div className="bg-white/90 backdrop-blur rounded-2xl shadow-2xl p-6 border-4 border-white">
      ...
      <select
        ...
        className="text-gray-500 w-full p-3 mb-4 border-2 border-gray-300 rounded-lg font-semibold"
      >
      ...
      {loading ? (
        ...
        <>
          ...
          <p className="text-gray-600">Viento: {weather?.current_weather.windspeed} km/h</p>
        </>
      )}
      <div className="mt-4 p-3 bg-blue-50 rounded-lg border-2 border-blue-200">
        <p className="text-xs text-blue-800">🔄 Datos actualizados dinámicamente</p>
      </div>
    </div>
  )
}
